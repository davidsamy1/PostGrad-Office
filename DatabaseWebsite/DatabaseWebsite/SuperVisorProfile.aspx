<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuperVisorProfile.aspx.cs" Inherits="DatabaseWebsite.SuperVisorProfile" %>
      ...
      <form id="form1" runat="server">
            <asp:GridView ID="GridView1"    
               ...
               <span>Name</span>
                ...
                <asp:TextBox ID="Name" class="text" runat="server" MaxLength="20"> </asp:TextBox>
                ...
                <asp:TextBox ID="Faculty" runat="server" class="text" MaxLength="20" ></asp:TextBox>
              
            
            <asp:Button ID="UpdateMyInformation" class="btn" runat="server" Text="Update Info" OnClick="UpdateInfo" Width="732px" Font-Size="10pt" />
      </form>
    </section>
