<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuperVisorAddDefense.aspx.cs" Inherits="DatabaseWebsite.SuperVisorAddDefense" %>
  ...
  <body>
    ...
    <section class="main-content">
      <form id="form1" runat="server">
               ...
               <span>Enter Thesis Serial Number:</span>          
            <asp:TextBox ID="TextBox2" runat="server" class="text"  type="number" min="0" max="1000000" step="1"></asp:TextBox>
          <span>Enter Defense Date:</span> 
            <asp:TextBox ID="TextBox3" runat="server" class="text" textmode="Date"></asp:TextBox>
          <span>Enter Defense Location:</span> 
            <asp:TextBox ID="TextBox4" runat="server" class="text" MaxLength="15"></asp:TextBox>

               <asp:Button ID="Button2"  runat="server" Text="Add Defense For Gucian" Width="900px" OnClick="Button2_Click"/>
                <asp:Button ID="Button1"  runat="server" Text="Add Defense For Non Gucian" Width="900px" OnClick="Button1_Click" />
      </form>
    </section>
