<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuperVisorEvaluateReport.aspx.cs" Inherits="DatabaseWebsite.SuperVisorEvaluateReport" %>
  ...
  <body>
    ...
    <section class="main-content">
      <form id="form1" runat="server">
          ...
          <span>Enter Progress Report No.:</span> 
            <asp:TextBox ID="TextBox3" runat="server" class="text"  type="number" min="0" max="100" step="1"></asp:TextBox>
          <span>Enter Evaluation:</span> 
            <asp:TextBox ID="TextBox4" runat="server" class="text" type="number" min="0" max="3" step="1"></asp:TextBox>

                <asp:Button ID="Button1"  runat="server" Text="Evaluate Progress Report" Width="900px" OnClick="Button1_Click" />
      </form>
    </section>
