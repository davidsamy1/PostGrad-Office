<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuperVisorStudents.aspx.cs" Inherits="DatabaseWebsite.SuperVisorStudents" %>
    ...
    <section class="main-content">
      <form id="form1" runat="server">
            <asp:GridView ID="GridView1"    
              ...
              <div>          
                <asp:TextBox ID="Studentid"  class="text" runat="server" type="number" min="0" max="1000000" step="1"></asp:TextBox>
              </div>
 
               <asp:Button ID="Button2"  runat="server" 
                Text="View Publications" Width="900px" OnClick="Button2_Click" 
                 />
