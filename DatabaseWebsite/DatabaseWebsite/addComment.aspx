<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addComment.aspx.cs" Inherits="DatabaseWebsite.addComment" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <asp:Label class ="label" ID="Label1" runat="server" Text="Comment:"></asp:Label>
            <br />
