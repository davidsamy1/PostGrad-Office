<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="link and add
publications.aspx.cs"
Inherits="WebApplication1.link_and_add_publications" %>
  ...
  <body>
    ...
    <section class="main-content">
      <form id="form1" runat="server">
        <h1 class="heading">ADD PUBLICATION</h1>
        <asp:label class="label"> TITLE : </asp:label>
        <asp:TextBox
          class="text"
          ID="title1"
          runat="server"
        ...
        <asp:label class="label"> HOST </asp:label>
        <asp:TextBox
          class="text"
          ID="host"
          runat="server"
        ...
        <asp:label class="label"> PLACE </asp:label>
        ...
        <asp:label class="label"> publication date </asp:label>
        <asp:TextBox
          class="text"
          ID="date"
          runat="server"
        ...
        <label class="label" for="accpted"> ACCPTED : </label>
        <asp:CheckBox ID="accpted" class="toggle" runat="server" />

        <h1 class="heading">LINK THE PUBLICATION TO THESIS</h1>
        THESISSERIALNO. :
        <asp:TextBox
          class="text"
          ID="TextBox5"
