<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuperVisorCancelThesis.aspx.cs" Inherits="DatabaseWebsite.SuperVisorCancelThesis" %>
    ...
    <section class="main-content">
      <form id="form1" runat="server">
            ...
            <asp:TextBox ID="TextBox2" runat="server" class="text"  type="number" min="0" max="1000000" step="1"></asp:TextBox>
                <asp:Button ID="Button1"  runat="server" Text="Cancel thesis" Width="900px" OnClick="Button1_Click" />
      </form>
    </section>
